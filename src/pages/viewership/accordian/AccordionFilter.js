        ...
        <div className="view-duration">
            <div className="view-block">
                ...
                <div className="radio-list">
                    <div className='radio-box'>
                        <input id='content' value="Channel" name="view_by" type="radio" onChange={(e)=>filterChange(e)} defaultChecked />
                        <label htmlFor='content'><img src={content_icon} />Channel</label>
                    </div>
                    <div className='radio-box'>
                        <input id='Genre' value="Genre" name="view_by" type="radio" onChange={(e)=>filterChange(e)} />
                        <label htmlFor='Genre'><img src={live_tv} />Genre</label>
                    </div>
                    <div className='radio-box'>
                        <input id='Location' value="Location" name="view_by" type="radio" onChange={(e)=>filterChange(e)} />
                        <label htmlFor='Location'><img src={room} />Location</label>
                    </div>
                </div>
            </div>
            <div className="duration-block">
                ...
                <div className="radio-list">
                    ...
                    <div className='radio-box'>
                        <input id='Week' value="Week" name="Duration" type="radio" onChange={(e)=>filterChange(e)} />
                        <label htmlFor='Week'>This Week</label>
                    </div>
                    <div className='radio-box'>
                        <input id='Month' value="Month" name="Duration" type="radio" onChange={(e)=>filterChange(e)} />
                        <label htmlFor='Month'>This Month</label>
                    </div>
                    <div className='radio-box'>
                        <input id='Year' value="Year" name="Duration" type="radio"onChange={(e)=>filterChange(e)} />
